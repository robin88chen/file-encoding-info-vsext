...
namespace FileEncodingInfo
{
    ...
    /// </summary>
    internal class EncodingInfoMargin : Canvas, IWpfTextViewMargin
    {
        /// <summary>
        /// Margin name.
        /// </summary>
        ...
        public const string MarginName = "EncodingInfoMargin";
        ...
        private readonly EncodingInfoMarginFactory m_factory;
        private readonly IWpfTextView m_textView;

        /// <summary>
        /// Initializes a new instance of the <see cref="EncodingInfoMargin"/> class for a given <paramref name="textView"/>.
        /// </summary>
        /// <param name="textView">The <see cref="IWpfTextView"/> to attach the margin to.</param>
        public EncodingInfoMargin(IWpfTextView textView, IWpfTextViewHost host, EncodingInfoMarginFactory factory)
        {
        ...
        {
            return string.Equals(marginName, EncodingInfoMargin.MarginName, StringComparison.OrdinalIgnoreCase) ? this : null;
        }

        /// <summary>
        /// Disposes an instance of <see cref="EncodingInfoMargin"/> class.
        /// </summary>
        public void Dispose()
        {
            if (!this.isDisposed)
